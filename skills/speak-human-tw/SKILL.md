...
你只要提出修改、改寫或潤飾文章的要求，並在同一個需求中提到「說人話」「去 AI 味」或「去AI味」，就啟用本 skill。這些是意圖觸發詞，不需要逐字符合固定句型；例如「幫我修改文章，說人話一點」「這篇請去 AI 味」「幫我把文章去AI味」都算。

如果你只是在詢問這些詞的意思，沒有要求處理文字，不要自動改稿。觸發後仍依下方規則判斷是先審閱、直接改寫或只標問題；觸發詞本身不代表可以略過你指定的交付方式。
